      ...
      <div className="relative flex flex-col p-8 w-96 text-neutral-300 bg-neutral-800 rounded-md mb-8">
        ...
        <form className="flex flex-col gap-8">
          ...
          <div>
            ...
            <input ref={nameRef} type="text" id="name" className="text-md rounded-lg block w-full p-2.5 bg-neutral-700 text-white focus:ring-blue-500 focus:border-blue-500" required value={chessBot.name} />
          </div>

          <div>
            <label htmlFor="name" className="block mb-2 text-md font-medium text-gray-900 dark:text-white">URL</label>
            <input ref={urlRef} type="text" id="url" className="text-md rounded-lg block w-full p-2.5 bg-neutral-700 text-white focus:ring-blue-500 focus:border-blue-500" required value={chessBot.url} />
            <button 
              type="button" 
